<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="UTF-8"%>
<%@ page import ="es.uco.pw.business.contacto.Contacto,es.uco.pw.data.dao.contacto.ContactoDAO,es.uco.pw.business.contacto.*" %>
...
int registrado = 0;
 ...
 if(customerBean == null || customerBean.getEmail().equals("")){
	 ...
	 if((email != null) && (nombre !=null) && (apellidos != null) && (Password != null) && (fecha != null) && (intereses !=  null)){
		 ...
		 ContactoDAO registro = new ContactoDAO(application.getInitParameter("RutaSQL"),application.getInitParameter("url"));
		 Contacto user = new Contacto();
		 /*Se comprueba que no existe el mismo email en la base de datos*/
		 if(registro.getObject(email).getEmail().equals(""))
		 {
