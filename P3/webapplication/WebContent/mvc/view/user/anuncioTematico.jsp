...
<html>
	<head>
		...
		<title>AnuncioTematico</title>
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/estilo1.css">	
	</head>
	<body>
	
	<%
		/*La informacion recibida de los servlets es procesada y dependiendo de la opcion escogida, se mostrara un formulario u otro.*/
		int crear = 0;
		int modificar = 0;
		int eliminar = 0;
		int obtener = 0;
		...
		%>
			<!-- Formulario para la creacion de anuncio Tematico -->
			<div id="cuadro">
					<form  id="form" method="post" action="anuncioTematico">
						
						<p id="titulo">Crear Anuncio Tematico</p>
						<hr>
						<input id="selector1" name="selector1" type="hidden" value="crear"/>
						<br/><br/>
						<label id="subtitulo3" for="id">ID</label>
						<br/><br/>
						<input type="text" id="id"name="id" class="entrada" placeholder="Introduzca el id del anuncio" onkeydown="checkId()"/>
						<span id="text1"></span>
						<br/><br/>
						<label id="subtitulo3" for="tituloAnuncio">Titulo</label>
						<br/><br/>
						<input type="text" id="tituloAnuncio" name="tituloAnuncio" class="entrada" placeholder="Introduzca un titulo" onkeydown="checkTitulo()"/>
						<span id="text2"></span>
						<br/><br/>
						<label id="subtitulo3" for="cuerpo">Cuerpo</label>
						<br/><br/>
						<input type="text" id="cuerpo" name="cuerpo" class="entrada" placeholder="Introduzca un cuerpo" onkeydown="checkCuerpo()"/>
						<span id="text3"></span>
						<br/><br/>
						<label id="subtitulo3" for="propietario">Propietario</label>
						<br/><br/>
						<input id="propietario" name="propietario" type="text" class="entrada" placeholder="Introduzca el propietario" onkeydown="checkPropietario()"/>
						<span id="text4"></span>
						<br/><br/>
						...
						<br/><br/>
						<input type="text" id="fechaPublicacion" name="fechaPublicacion"  class="entrada2" placeholder="Introduzca una fecha de Publicacion" onkeydown="checkFechaP()">
						<span id="text6"></span>
						<br/><br/>
						<label id="subtitulo3" for="interes">Interes</label>
						<br/><br/>
						<input type="text" id="interes" name="interes"  class="entrada2" placeholder="Introduzca los intereses del anuncio" onkeydown="checkInteres()">
						<span id="text7"></span>
						<br/><br/>
		...
		%>
		<!-- Formulario para la eliminacion de anuncio Tematico -->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioTematico">
				<p id="titulo">Eliminar Anuncio Tematico</p>
				<hr>
				<input id="selector1" name="selector1" type="hidden" value="eliminar"/>
				<br/><br/>
				<label id="subtitulo3" for="id">Id Anuncio</label>
				<br/><br/>
				<input type="text" name="id" id="id" class="entrada" placeholder="Introduzca el id del anuncio" onkeydown="checkId()"/>
				<span id="text1"></span>
				<br/><br/>
		...
		%>
		<!-- Formulario para la modificacion de anuncio Tematico -->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioTematico">
				<p id="titulo">Modificar Anuncio Tematico</p>
				<hr>
				<input id="selector1" name="selector1" type="hidden" value="modificar"/>
				<br/><br/>
				...
				<span id="text6"></span>
				<br/><br/>
				<label id="subtitulo3" for="interes">NuevoInteres(es)</label>
				<br/><br/>
				<input type="text" id="interes" name="interes"  class="entrada2" placeholder="Introduzca los intereses del anuncio" onkeydown="checkInteres()"/>
				<span id="text7"></span>
				<br/><br/>
		...
		%>
		<!-- El primer formulario es para seleccionar el anuncio de la BD y el segundo para mostrar los datos del anuncio seleccionado-->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioTematico">
				<p id="titulo">Obtener Anuncio Tematico</p>
				<hr>
				<input id="selector1" name="selector1" type="hidden" value="obtener"/>
				<br/><br/>
				<label id="subtitulo3" for="id">Id Anuncio</label>
				<br/><br/>
				<input type="text" name="id" id="id" class="entrada" placeholder="Introduzca el id del anuncio" onkeydown="checkId()"/>
		...
		%>
			<div id="cuadro">
			<form id="form" method="get" action="anuncioTematico">
				<p id="titulo">Anuncio Tematico obtenido</p>
				<hr>
				...
				<br/><br/>
				<label id="subtitulo3" for="interes"><%=request.getAttribute("Interes")%></label>
		...
		%>
		<!-- Formulario para la publicacion de un anuncio Tematico-->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioTematico">
				<p id="titulo">Publicar Anuncio Tematico</p>
				<hr>
				<input id="selector1" name="selector1" type="hidden" value="publicar"/>
				<br/><br/>
				<label id="subtitulo3" for="id">Id Anuncio</label>
				<br/><br/>
				<input type="text" name="id" id="id" class="entrada" placeholder="Introduzca el id del anuncio" onkeydown="checkId()"/>
		...
		<%}else if(archivar == 1){%>
		<!-- Formulario para archivar un anuncio Tematico-->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioTematico">
				<p id="titulo">Archivar Anuncio Tematico</p>
				<hr>
				<input id="selector1" name="selector1" type="hidden" value="archivar"/>
				<br/><br/>
				<label id="subtitulo3" for="id">Id Anuncio</label>
				<br/><br/>
				<input type="text" name="id" id="id" class="entrada" placeholder="Introduzca el id del anuncio" onkeydown="checkId()"/>
