...
<html>
	<head>
		...
		<title>AnuncioIndividualizado</title>
	...
	<%
		...
		%>
		<!-- Formulario para la creacion de un anuncio individualizado -->
			<div id="cuadro">
					<form id="form" method="post" action="anuncioIndividualizado">
						
						<p id="titulo">Crear Anuncio Individualizado</p>
						<hr>
		...
		%>
		<!-- Formulario para la eliminacion de un anuncio individualizado -->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioIndividualizado">
				<p id="titulo">Eliminar Anuncio Invidualizado</p>
				<hr>
		...
		%>
		<!-- Formulario para la modificacion de un anuncio individualizado -->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioIndividualizado">
				<p id="titulo">Modificar Anuncio Invidualizado</p>
				<hr>
		...
		%>
		<!-- Formulario para la obtención de un anuncio individualizado, el primero se usa para seleccionar de la BD qué anuncio se quiere obtener y el segundo para mostrar sus datos -->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioIndividualizado">
				<p id="titulo">Obtener Anuncio Individualizado</p>
				<hr>
		...
		%>
			<div id="cuadro">
			<form id="form" method="get" action="anuncioIndividualizado">
				<p id="titulo">Anuncio Individualizado obtenido</p>
				<hr>
		...
		%>
		<!-- Formulario para la publicación de un Anuncio Individualizado -->
		<div id="cuadro">
			<form id="form" method="post" action="anuncioIndividualizado">
				<p id="titulo">Publicar Anuncio Individualizado</p>
				<hr>
		...
		<%}else if(archivar == 1){%>
		<!-- Formulario para archivar un Anuncio Individualizado -->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioIndividualizado">
				<p id="titulo">Archivar Anuncio Individualizado</p>
				<hr>
