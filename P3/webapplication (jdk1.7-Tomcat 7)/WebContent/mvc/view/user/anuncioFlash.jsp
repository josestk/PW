...
<html>
	<head>
		...
		<title>Creacion Anuncio Flash</title>
	...
	<%
		...
		**/
		...
		%>
		<!-- Formulario para la creacion de un Anuncio Flash-->
			<div id="cuadro">
					<form  id="form" method="post" action="anuncioFlash">
						
						<p id="titulo">Crear Anuncio Flash</p>
						<hr>
						...
						<span id=text6></span>
						<br/><br/>
						<label id="subtitulo3" for="fechaInicioPublicacion">FechaInicio</label>
						<br/><br/>
						<input type="text" id="fechaInicioPublicacion" name="fechaInicioPublicacion"  class="entrada2" placeholder="Introduzca la fecha publicacion" onkeydown="checkFechaIP()">
						<span id=text7></span>
						<br/><br/>
						<label id="subtitulo3" for="fechaFinalPublicacion">FechaFinalPublicacion</label>
						<br/><br/>
						<input type="text" id="fechaFinalPublicacion" name="fechaFinalPublicacion"  class="entrada2" placeholder="Introduzca la fecha publicacion" onkeydown="checkFechaFP()">
						<span id=text8></span>
						<br/><br/>
		...
		%>
				<!-- Formulario para la eliminacion de un Anuncio Flash-->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioFlash">
				<p id="titulo">Eliminar Anuncio Flash</p>
				<hr>
		...
		%>
				...
				<!-- Formulario para la modificacion de un Anuncio Flash-->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioFlash">
				<p id="titulo">Modificar Anuncio Flash</p>
				<hr>
		...
		%>
				<!-- Formulario para la obtencion de un Anuncio Flash-->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioFlash">
				<p id="titulo">Obtener Anuncio Flash</p>
				<hr>
		...
		%>
				<!-- Formulario para la actualizacion de un Anuncio Flash-->
		
			<div id="cuadro">
			<form id="form" method="get" action="anuncioFlash">
				<p id="titulo">Anuncio Flash obtenido</p>
				<hr>
				...
				<br/><br/>
				<label id="subtitulo3" for="fechaInicioPublicacion"><%=request.getAttribute("fechaInicio")%></label>
				<br/><br/>
				<label id="subtitulo3" for="fechaFinalPublicacion"><%=request.getAttribute("fechaFinal")%></label>
				<br/><br/>
		...
		%>
				<!-- Formulario para la publicacion de un Anuncio Flash-->
		
		<div id="cuadro">
			<form id="form" method="post" action="anuncioFlash">
				<p id="titulo">Publicar Anuncio Flash</p>
				<hr>
		...
		<%}else if(archivar == 1){%>
				...
				<!-- Formulario para el archivado de un Anuncio Flash-->
			
			<div id="cuadro">
			<form id="form" method="post" action="anuncioFlash">
				<p id="titulo">Archivar Anuncio Flash</p>
				<hr>
...
<%} %>
		...
		function checkDestinatarios(){
			...
			function checkFechasIP(){
				
				let form = document.getElementById("form");
				let text2 = document.getElementById("text7");
				let fecha = document.getElementById("fechaInicioPublicacion").value;
				let pattern = /^(?:3[01]|[12][0-9]|0?[1-9])([\-/.])(0?[1-9]|1[1-2])\1\d{4}$/;
				if(pattern.test(fecha)){
					
					form.classList.remove("valid");
					form.classList.add("invalid");
					text2.innerHTML = "Introduzca una fecha de inicio valida";
					text2.style.color = "#ff0000";
					...
					form.classList.add("valid");
					form.classList.remove("invalid");
					text2.innerHTML = "Fecha de inicio valida";
					text2.style.color = "#008000";
				}
				
			};

			function checkFechasFP(){
				
				let form = document.getElementById("form");
				let text2 = document.getElementById("text8");
				let fecha = document.getElementById("fechaFinalPublicacion").value;
				let pattern = /^(?:3[01]|[12][0-9]|0?[1-9])([\-/.])(0?[1-9]|1[1-2])\1\d{4}$/;
				if(pattern.test(fecha)){
					
					form.classList.remove("valid");
					form.classList.add("invalid");
					text2.innerHTML = "Introduzca una fecha final valida";
					text2.style.color = "#ff0000";
					...
					form.classList.add("valid");
					form.classList.remove("invalid");
					text2.innerHTML = "Fecha final valida";
					text2.style.color = "#008000";
				}
