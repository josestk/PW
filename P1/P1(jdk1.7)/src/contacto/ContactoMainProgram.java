...
public class ContactoMainProgram {
	...
	public static void main(String[] args) throws NullPointerException
	{
		...
		System.out.println("Aqui se muentran los contactos que hay en la base de datos...");
		...
		System.out.println("Veamos la base de datos como esta ahora");
			contacto.ImprimirContactos();
		...
		System.out.println("Aqui se muestran los contactos encontrados");
